...
const SETUP_STEP_DEFS = [
    { icon: <BusinessIcon sx={{ fontSize: 18 }} />,       title: 'Stofna húsfélag',   sub: 'Heiti, kennitala, heimilisfang',                       time: '~2 mín.', navPath: null },
    { icon: <HomeIcon sx={{ fontSize: 18 }} />,           title: 'Skrá íbúðir',       sub: 'Íbúðir + eignarhlutföll',                              time: '~15 mín.', navPath: '/ibudir', navState: { openAdd: true } },
    { icon: <PersonAddIcon sx={{ fontSize: 18 }} />,      title: 'Skrá eigendur',     sub: 'Eigendur íbúða',                                       time: '~10 mín.', navPath: '/eigendur' },
    { icon: <GroupIcon sx={{ fontSize: 18 }} />,          title: 'Bæta við stjórn',   sub: 'Formaður og gjaldkeri',                                time: '~3 mín.', navPath: null },
